...
$(function(){
        $('#contactable_handler').click(function(){
                $('#contactable_inner').click();
				
				$('#contactable_handler').html(  $('#contact_details').html() );
...
moveShare = function() {
	$("#contactable_inner").stop();
	offset = ($(window).height() / 2) - $("#contactable_inner").height() / 2;
	$("#contactable_inner").css('position', "absolute");
	$("#contactable_inner").animate({
